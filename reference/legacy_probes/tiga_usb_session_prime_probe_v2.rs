//! Zoom75 TIGA — USB random-access probe v2.
//!
//! Difference from v1:
...
const RETRY_BACKOFF: Duration = Duration::from_millis(35);
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Zoom75 TIGA — USB SESSION-PRIME random-access probe v2");
    println!("-------------------------------------------------------");
